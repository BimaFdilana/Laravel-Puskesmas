        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <div class="container d-flex align-items-center">
                ...
                <a class=" nav-custom-link nav-link text-white me-auto d-flex align-items-center" style="gap: 8px;">
                    <i class="fas fa-envelope"></i> Email: Uptpuskesmasmeskom@gmail.com </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p><a href="mailto:Uptpuskesmasmeskom@gmail.com"
                            class="external-links">Uptpuskesmasmeskom@gmail.com</a></p>
                </div>
                <div class="col-md-3">
                    <h5>Menu</h5>
                    <ul>
