...
use PhpOffice\PhpSpreadsheet\Cell\DataType; // <-- 1. Tambahkan use statement ini
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                foreach ($this->data as $posyanduName => $bayiGroup) {
                    ...
                    foreach ($bayiGroup as $bayi) {
                        // Menulis data sel per sel untuk kontrol penuh
                        ...
                        $sheet->setCellValue('F' . $rowNumber, $bayi->jenis_imunisasi);
                        $sheet->setCellValue('G' . $rowNumber, $bayi->alamat_lengkap);

                        // Menulis NIK secara eksplisit sebagai TIPE STRING
